...
const MACHINES = [['all-around weeder','desmalezadora universal'], ['baler (250 kg round bale)','enfardadora (rollo de 250 kg)'], ['baler (250 kg square bale)','enfardadora (fardo de 250 kg)'], ['baler (silage)','enfardadora (ensilaje)'], ['biocide spraying','aspersión de biocida'], ['chisel plough','arado de cincel'], ['combination rotary harrow/ sower','grada rotativa combinada con sembradora'], ['combination spike drum/sower','rodillo de púas combinado con sembradora'], ['combine','cosechadora'], ['combine harrow (harrow + seed drill)','grada combinada (grada + sembradora de precisión)'], ['corn combine','cosechadora de maíz'], ['coulter','cuchilla surcadora'], ['disc gang','grupo de discos'], ['disc harrow','grada de discos'], ['disc harrowing','rastreo con grada de discos'], ['disk bedder','formadora de camas con discos'], ['fertiliser spraying','aspersión de fertilizante'], ['fertiliser spreading','esparcido de fertilizante'], ['field cultivator/ridger','cultivadora de campo / aporcadora'], ['flaming','flameo'], ['foliage cut','corte de follaje'], ['forage blower/washer','sopladora / lavadora de forraje'], ['forage harvester','cosechadora de forraje'], ['forage harvester - corn hoeing with chipper','cosechadora de forraje - deshoje de maíz con picadora'], ['forage harvester - grassland','cosechadora de forraje - pastizal'], ['grain drill','sembradora de grano'], ['grain drill-notill','sembradora de grano - siembra directa'], ['grass seeding','siembra de pasto'], ['grooming','rastrillado'], ['grubbing','desraizado'], ['herbicide spraying','aspersión de herbicida'], ['hilling of mounds','aporque de camellones'], ['hoe drill','sembradora de azadón'], ['hoeing and grooming','azadoneo y rastrillado'], ['land plane/destoner','nivelador de tierra / desempedradora'], ['liming','encalado'], ['manure injections','inyección de estiércol'], ['manure spreader','esparcidora de estiércol'], ['milling','molienda'], ['moldboard plough','arado de vertedera'], ['mower-conditioner','segadora acondicionadora'], ['mower-conditioner - self-propelling rotary mower with conditioner','segadora acondicionadora - segadora rotativa autopropulsada con acondicionador'], ['mower/grader','segadora / niveladora'], ['mower/grader - rotary mower - cultivation','segadora / niveladora - segadora rotativa - cultivo'], ['mowing - disc mower','siega - segadora de discos'], ['mulching - seeding - corn','acolchado - siembra - maíz'], ['pneumatic drill','sembradora neumática'], ['power harrow','grada rotativa'], ['pressing of dry crop (straw/hay) high-density pick-up baler (13 kg/bale)','prensado de cultivo seco (paja/heno) - enfardadora recogedora de alta densidad (13 kg/paca)'], ['pump tank truck - drag hose','camión cisterna con bomba - manguera de arrastre'], ['rake','rastrillo'], ['ridging','formación de camellones'], ['roatry cultivation of tramlines','cultivo rotativo de carriles'], ['rod weeder','desmalezadora de varilla'], ['roller harrow','grada de rodillo'], ['roller harrowing','rastreo con rodillo'], ['roller packer','rodillo compactador'], ['rotary hoe/bed tiller','azada rotativa / fresadora de camas'], ['row crop cultivator','cultivadora de hileras'], ['row crop planter','sembradora de hileras'], ['scrubbing','desbroce'], ['subsoiler','subsolador'], ['subsoiling (tillage)','subsolado (labranza)'], ['sweep plough','arado de aletas'], ['tine harrow/seed handling transport','grada de púas / transporte de manejo de semilla'], ['tooth harrow','grada de dientes'], ['vacuum tanker','cisterna de vacío'], ['wagon for ventilated hay','carro para heno ventilado'], ['wagon for wilted material','carro para material marchito'], ['windrower/swather','hileradora'], ['windrower/swather - rotary tedder','hileradora - hilerador rotativo'], ['winter cut - flail mulcher','corte de invierno - desbrozadora de martillos'], ['wrapping of bales','enfardado con película'], ['beet harvester','cosechadora de remolacha'], ['beet harvester - standard','cosechadora de remolacha - estándar'], ['chopping wine wood','trituración de madera de vid'], ['cotton picker','recolectora de algodón'], ['cotton stripper/potato topper','despuntadora de algodón / descoronadora de papa'], ['crop protection - syringe (orchards)','protección de cultivos - jeringa (huertos)'], ['crop protection - syringe (viniculture)','protección de cultivos - jeringa (viticultura)'], ['fertiliser spraying (orchards)','aspersión de fertilizante (huertos)'], ['grape harvester','cosechadora de uva'], ['mulching - flail mulcher (orchards)','acolchado - desbrozadora de martillos (huertos)'], ['mulching - flail mulcher (viniculture)','acolchado - desbrozadora de martillos (viticultura)'], ['peas harvester','cosechadora de chícharo'], ['potato destoner','desempedradora de papa'], ['potato harvester','cosechadora de papa'], ['potato lifter loader','levantadora cargadora de papa'], ['potato planting','plantadora de papa'], ['potato planting - potato planter - semiautomatic','plantación de papa - plantadora de papa - semiautomática'], ['potato windrower','hileradora de papa'], ['self-propelling potato harvester','cosechadora de papa autopropulsada'], ['self-propelling potato lifter loader','levantadora cargadora de papa autopropulsada'], ['subsoiling (viniculture)','subsolado (viticultura)'], ['tomato harvester','cosechadora de tomate']];
...
const UNIT_RESIDUE = [['kg','kg'], ['lb','libra (lb)'], ['tonne','tonelada (t)']];
const UNIT_RATE_PESTICIDE = [['kg/acre','kg/acre'], ['lb/acre','lb/acre'], ['kg/ha','kg/ha'], ['L/ha','L/ha'], ['gal/acre','gal/acre']];
...
const SECTIONS = [
  {id: 'farm', title: 'About your farm', titleEs: 'Sobre su finca', enabled: true, repeatable: false,
    ...
    {id: 'certificationOther', q: 'If other, which certification?', qEs: 'Si es otra, ¿cuál?', kind: 'text', dependsOn: {field: 'certification', show: ['Other']}, placeholder: 'e.g. SQF, BRC', phEs: 'p. ej. SQF, BRC'},
    {id: 'certifier', q: 'Certifier(s) (if you have one)', qEs: 'Certificadora(s) (si tiene)', kind: 'text', dict: 'cert.certifier', placeholder: 'e.g. QAI, Argencert, OIA', phEs: 'p. ej. QAI, Argencert, OIA'},
    {id: 'farmSize', q: 'Total farm size', qEs: 'Superficie total de la finca', kind: 'numberUnit', units: UNIT_AREA, dict: 'land.lmu_acres',
    ...
    {id: 'mailing', q: 'Mailing address (optional)', qEs: 'Dirección postal (opcional)', kind: 'text', full: true,
      hint: 'Adams would love to mail you a small gift. This is optional, and is not shared.', hintEs: 'A Adams le encantaría enviarle un pequeño regalo por correo. Esto es opcional y no se comparte.'},
  ]},
  {id: 'cropsoil', title: 'Crop & Soil', titleEs: 'Cultivo y suelo', enabled: true, repeatable: false,
    ...
    fields: [
    {id: 'assessYear', q: 'Which harvest are you describing?', qEs: '¿De qué cosecha nos va a hablar?', kind: 'select', options: YEARS_ASSESS, default: '2025', full: true, dict: 'crop.year',
    ...
    {id: 'crop', q: 'Crop you are describing', qEs: 'Cultivo del que nos va a hablar', kind: 'select', options: CROPS, dict: 'crop.name'},
    ...
    {id: 'previousCrop', q: 'Crop that was on this field just before (for example wheat, or fallow)', qEs: 'Cultivo que hubo en este lote justo antes (por ejemplo trigo, o barbecho)', kind: 'text', chip: 'previousCrop', dict: 'crop.rotation', placeholder: 'e.g. wheat, or fallow', phEs: 'p. ej. trigo, o barbecho'},
    {id: 'growingArea', q: 'Growing area of this field', qEs: 'Superficie cultivada de este lote', kind: 'numberUnit', units: UNIT_AREA, dict: 'field.area',
    ...
    {id: 'totalHarvest', q: 'Total harvest from this field', qEs: 'Cosecha total de este lote', kind: 'numberUnit', units: UNIT_YIELD, dict: 'crop.yield',
    ...
    {id: 'residueMgmt', q: 'What do you do with the crop residue after harvest?', qEs: '¿Qué hace con el rastrojo después de la cosecha?', kind: 'select', options: RESIDUE_MGMT, full: true, dict: 'crop.residue',
      hint: 'Most growers pick "Left distributed on field, OR incorporated, OR mulched" unless residue was hauled away, burned, or composted.', hintEs: 'La mayoría elige "Dejado en el lote (esparcido, incorporado al suelo o sobre la superficie)" salvo que lo haya retirado, quemado o compostado.'},
    {id: 'residueDry', q: 'Residue left, dry weight (only if you know it)', qEs: 'Rastrojo que dejó en el lote, peso seco (solo si lo sabe)', kind: 'numberUnit', units: UNIT_RESIDUE,
  ...
  {id: 'fert', title: 'Fertilizer', titleEs: 'Fertilizante', enabled: true, repeatable: true, minItems: 1,
    ...
    fields: [
    {id: 'type', q: 'Fertilizer type', qEs: 'Tipo de fertilizante', kind: 'select', options: FERT_TYPES, full: true, dict: 'input.fert_type'},
    ...
    {id: 'method', q: 'How it was applied', qEs: 'Cómo se aplicó', kind: 'select', options: FERT_METHOD, dict: 'input.fert_method'},
    ...
    {id: 'pctAmmonium', q: '%N as ammonium', qEs: '%N como amonio', kind: 'percent', full: true,
      hint: 'Fills in by itself for common products once you pick a Fertilizer type above. Most single products are one form only. Only enter your own numbers here if you know your product\'s actual N-form mix - the N-P-K number on the bag (e.g. 20-10-10) does not tell you this.', hintEs: 'Se completa sola para los productos comunes una vez que elige un Tipo de fertilizante arriba. La mayoría de los productos son de una sola forma. Complete sus propios datos solo si conoce la mezcla real de su producto - el número N-P-K de la bolsa (p. ej. 20-10-10) no le dice esto.'},
    {id: 'pctNitrate', q: '%N as nitrate', qEs: '%N como nitrato', kind: 'percent',
      hint: 'Also fills in by itself once you pick a Fertilizer type above.', hintEs: 'También se completa sola una vez que elige un Tipo de fertilizante arriba.'},
    {id: 'pctUrea', q: '%N as urea', qEs: '%N como urea', kind: 'percent',
      hint: 'Also fills in by itself once you pick a Fertilizer type above.', hintEs: 'También se completa sola una vez que elige un Tipo de fertilizante arriba.'},
    {id: 'pctP2O5', q: '%P2O5 (phosphorus)', qEs: '%P2O5 (fósforo)', kind: 'percent',
      hint: 'The 2nd number in your fertilizer\'s N-P-K analysis (e.g. 20-10-10 -> 10% P2O5).', hintEs: 'El 2.º número del análisis N-P-K del fertilizante (p. ej. 20-10-10 -> 10% P2O5).'},
    {id: 'pctK2O', q: '%K2O (potassium)', qEs: '%K2O (potasio)', kind: 'percent',
      hint: 'The 3rd number in your fertilizer\'s N-P-K analysis (e.g. 20-10-10 -> 10% K2O).', hintEs: 'El 3.er número del análisis N-P-K del fertilizante (p. ej. 20-10-10 -> 10% K2O).'},
    {id: 'rate', q: 'Application rate', qEs: 'Dosis de aplicación', kind: 'numberUnit', units: UNIT_RATE, dict: 'input.fert_rate',
    ...
    {id: 'appDate', q: 'Date of application', qEs: 'Fecha de aplicación', kind: 'date', dict: 'input.fert_date',
      hint: 'An approximate date is fine.', hintEs: 'Una fecha aproximada está bien.'},
    {id: 'rainNearApp', q: 'Heavy rain or irrigation within about a week of this application?', qEs: '¿Hubo lluvia fuerte o riego dentro de más o menos una semana de esta aplicación?',
      kind: 'select', full: true, weatherCheck: true, options: [['Yes, shortly before','Sí, poco antes'], ['Yes, shortly after','Sí, poco después'], ['No','No'], ['Not sure','No estoy seguro']],
    ...
    {id: 'inhibitor', q: 'Nitrification inhibitor', qEs: 'Inhibidor de nitrificación', kind: 'tick', dict: 'input.inhibitor',
  ...
  {id: 'irrigation', title: 'Irrigation', titleEs: 'Riego', enabled: true, repeatable: true, minItems: 1,
    ...
    fields: [
    {id: 'method', q: 'Method', qEs: 'Método', kind: 'select', options: IRR_METHOD, full: true, dict: 'water.method',
    ...
    {id: 'source', q: 'Water source', qEs: 'Fuente de agua', kind: 'select', options: IRR_SOURCE, dict: 'water.source'},
    {id: 'power', q: 'What powers the pump', qEs: 'Con qué funciona la bomba', kind: 'select', options: IRR_POWER, dict: 'water.power'},
    {id: 'pctIrrigated', q: '% of the field irrigated', qEs: '% del lote regado', kind: 'percent',
      hint: 'Enter 100 if the whole field was irrigated.', hintEs: 'Escriba 100 si regó todo el lote.'},
    ...
    {id: 'totalWater', q: 'Total water applied', qEs: 'Agua total aplicada', kind: 'numberUnit', units: UNIT_WATER, dict: 'water.applied',
  ...
  {id: 'pesticide', title: 'Pesticides', titleEs: 'Plaguicidas (agroquímicos)', enabled: true, repeatable: true, minItems: 0,
    ...
    fields: [
    {id: 'productName', q: 'Product name (from the label)', qEs: 'Nombre del producto (según la etiqueta)', kind: 'text', full: true, dict: 'input.pesticide'},
    ...
    {id: 'type', q: 'Type', qEs: 'Tipo', kind: 'select', options: PESTICIDE_TYPE,
      hint: 'Choose the most specific type that fits - only pick "Pesticide" if none of the others do.', hintEs: 'Elija el tipo más específico que corresponda - marque "Plaguicida" solo si ninguno de los otros aplica.'},
    ...
    {id: 'rate', q: 'Application rate', qEs: 'Dosis de aplicación', kind: 'numberUnit', units: UNIT_RATE_PESTICIDE},
  ...
  {id: 'management', title: 'Planting, tillage & cover crop', titleEs: 'Siembra, labranza y cultivo de cobertura', enabled: true, repeatable: false,
    ...
    fields: [
    {id: 'plantDate', q: 'Planting date', qEs: 'Fecha de siembra', kind: 'date', dict: 'crop.plant_date', hint: 'An approximate date is fine.', hintEs: 'Una fecha aproximada está bien.'},
    {id: 'harvestDate', q: 'Harvest date', qEs: 'Fecha de cosecha', kind: 'date', dict: 'crop.harvest_date', hint: 'An approximate date is fine.', hintEs: 'Una fecha aproximada está bien.'},
    {id: 'tillage', q: 'Tillage system', qEs: 'Sistema de labranza', kind: 'select', options: TILLAGE_SYS, full: true, dict: 'practice.tillage'},
    {id: 'tillagePasses', q: 'Tillage passes before planting', qEs: 'Pasadas de labranza antes de sembrar', kind: 'number', dict: 'practice.tillage_passes',
    ...
    {id: 'coverCrop', q: 'Cover crop', qEs: 'Cultivo de cobertura', kind: 'select', options: COVER_YN, dict: 'practice.cover_crop',
    ...
    {id: 'coverSpecies', q: 'Cover crop species or mix', qEs: 'Especies o mezcla del cultivo de cobertura', kind: 'text', dict: 'practice.cover_species', placeholder: 'e.g. rye + vetch', phEs: 'p. ej. centeno + vicia', dependsOn: {field: 'coverCrop', show: ['Yes']}},
    {id: 'coverPlantDate', q: 'Cover crop planted', qEs: 'Fecha de siembra del cultivo de cobertura', kind: 'date', dict: 'practice.cover_plant_date', dependsOn: {field: 'coverCrop', show: ['Yes']},
      hint: 'An approximate date is fine.', hintEs: 'Una fecha aproximada está bien.'},
    {id: 'coverEndDate', q: 'Cover crop ended', qEs: 'Fecha en que terminó el cultivo de cobertura', kind: 'date', dict: 'practice.cover_term_date', dependsOn: {field: 'coverCrop', show: ['Yes']},
      hint: 'An approximate date is fine. Should be after the planting date above.', hintEs: 'Una fecha aproximada está bien. Debe ser posterior a la fecha de siembra de arriba.'},
    {id: 'coverEndMethod', q: 'How the cover crop was ended', qEs: 'Cómo se terminó el cultivo de cobertura', kind: 'select', options: COVER_END, full: true, dict: 'practice.cover_term_method', dependsOn: {field: 'coverCrop', show: ['Yes']}},
  ...
  {id: 'machine', title: 'Machines and field passes', titleEs: 'Maquinaria y pasadas por el lote', enabled: true, repeatable: true, minItems: 0,
    ...
    fields: [
    {id: 'type', q: 'Machine type', qEs: 'Tipo de máquina', kind: 'select', options: MACHINES, full: true, dict: 'energy.machine'},
  ...
  {id: 'landchange', title: 'Land use change', titleEs: 'Cambio de uso del suelo', enabled: true, repeatable: true, minItems: 0, banner: 'landuse',
    ...
    {id: 'landFrom', q: 'Land use before', qEs: 'Uso del suelo antes', kind: 'select', options: LANDUSE_STATES,
      hint: '"Perennial" means pasture, alfalfa, orchard or vineyard.', hintEs: '"Perenne" significa pastura, alfalfa, frutales o viñedo.'},
    ...
    {id: 'tillageChange', q: 'Tillage', qEs: 'Labranza', kind: 'select', options: TILLAGE_3,
      hint: '"Full" means plow or disk, several passes. "Reduced" means strip-till, minimum-till, or one light pass.', hintEs: '"Convencional" significa arado o rastra, varias pasadas. "Reducida" significa en franjas, mínima, o una pasada liviana.'},
    ...
    {id: 'carbonTo', q: 'Carbon inputs after', qEs: 'Aportes de carbono después', kind: 'select', options: CARBON_INPUTS,
      hint: 'Same scale as above.', hintEs: 'Misma escala que arriba.'},
  ...
  {id: 'soilinfo', title: 'Soil data', titleEs: 'Datos del suelo', enabled: true, repeatable: false,
    ...
    {id: 'soilTexture', q: 'Soil texture (if you know it)', qEs: 'Textura del suelo (si la sabe)', kind: 'select', options: SOIL_TEXTURE,
      hint: 'How much sand, silt and clay the soil has. Rough feel test: gritty means sandy, sticky when wet means clay, smooth and floury means silt. A soil test is the sure way to know.', hintEs: 'Cuánta arena, limo y arcilla tiene el suelo. Prueba rápida al tacto: áspero es arenoso, pegajoso cuando está húmedo es arcilloso, suave y como harina es limoso. Un análisis de suelo es la forma segura de saberlo.'},
