...
const SECTIONS = [
  {id: 'farm', title: 'About your farm', titleEs: 'Sobre su finca', enabled: true, repeatable: false,
    ...
    {id: 'certifier', q: 'Certifier(s) (if you have one)', qEs: 'Certificadora(s) (si tiene)', kind: 'text', dict: 'cert.certifier', placeholder: 'e.g. Argencert, OIA', phEs: 'p. ej. Argencert, OIA'},
  ...
  {id: 'management', title: 'Planting, tillage & cover crop', titleEs: 'Siembra, labranza y cultivo de cobertura', enabled: true, repeatable: false,
    ...
    {id: 'harvestDate', q: 'Harvest date', qEs: 'Fecha de cosecha', kind: 'date', dict: 'crop.harvest_date'},
